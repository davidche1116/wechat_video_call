...
import com.dc16.wechat_video_call.WechatData
...
//      val actions: ArrayList<Int!>? = intent.getIntegerArrayListExtra("actions")
  ...
  fun isAccessibilitySettingsOn(mContext: Context): Boolean {
    ...
    val service: String = mContext.getPackageName() + "/" + WechatAccessibility::class.java.getCanonicalName()
//    val service: String = mContext.getPackageName() + "/"
    ...
    val mStringColonSplitter: TextUtils.SimpleStringSplitter = SimpleStringSplitter(':')
